...
namespace margelo::nitro::munimbluetooth {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimbluetooth/Func_void_BLEDevice;";
   ...
   */
  class JFunc_void_BLEDevice_cxx final: public jni::HybridClass<JFunc_void_BLEDevice_cxx, JFunc_void_BLEDevice> {
  public:
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimbluetooth/Func_void_BLEDevice_cxx;";
