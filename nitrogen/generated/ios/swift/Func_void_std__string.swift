...
/**
 * Wraps a Swift `(_ deviceId: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.munimbluetooth.bridge.swift

  private let closure: (_ deviceId: String) -> Void

  public init(_ closure: @escaping (_ deviceId: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(deviceId: std.string) -> Void {
    self.closure(String(deviceId))
  }
